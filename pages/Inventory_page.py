...
class InventoryPage(BasePage):
    ...
    def burger_menu(self):
        return self.page.locator(InventoryLocators.BURGER)
    @property
    def cross_button(self):
        return self.page.locator(InventoryLocators.CROSS)
    @property
    def filter(self):
        return self.page.locator(InventoryLocators.FILTER)
    @property
    def item_names(self):
        return self.page.locator(InventoryLocators.ITEM_NAMES)
    @property
    def item_prices(self):
        return self.page.locator(InventoryLocators.ITEM_PRICES)
    @property
    def cart_badge(self):
        return self.page.locator(InventoryLocators.CART_BADGE)
    @property
